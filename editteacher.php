...
if (isset($_POST['name'])) {
  $id = $_POST["id"];
  $sid = $_POST["school"];
  teacher_update($_POST['name'], $_POST['email'], $_POST['phone'], $_FILES["image"], $_POST['school']);
  header("Location:teacher.php?id=$sid");
}
            ...
            <div class="d-flex ml-auto flex-column flex-lg-row align-items-center">
              <ul class="navbar-nav  ">
                <li class="nav-item active">
                  <a class="nav-link" href="teacher.php?id=<?php echo $row['school_id']; ?>"> Home <span class="sr-only">(current)</span></a>
                </li>
              </ul>
              ...
              <div class="contact-form">
                ...
                <form method="POST" action="editteacher.php" enctype="multipart/form-data">
                  ...
                  <div>
                    ...
                    <input type="hidden" placeholder="school_id" name="id" value=<?php echo $row['id']; ?>>
                  </div>
