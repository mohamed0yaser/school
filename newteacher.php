...
if (isset($_POST['name'])) {
  ...
  $sql = "INSERT INTO teacher (name , school_id , phone , email , image) VALUES ('$name', $school_id ,'$phone', '$email' , '$filename')";
            ...
            <div class="d-flex ml-auto flex-column flex-lg-row align-items-center">
              <ul class="navbar-nav  ">
                <li class="nav-item active">
                  <a class="nav-link" href="teacher.php?id=<?php echo $id ?>"> Home <span class="sr-only">(current)</span></a>
                </li>
              </ul>
