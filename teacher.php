...
<body>
  ...
  <section class="teacher_section layout_padding-bottom">
    <div class="container">
          ...
          <?php while ($row = mysqli_fetch_assoc($data)) { ?>
            <div class="card">
              ...
              <div class="d-flex justify-content-center mt-3">
                <a href="deleteteacher.php?did=<?php echo $row['id'] ?>&id=<?php echo $id ?>" class="call_to-btn  ">
                  <span>
                    Delete
                  </span>
              ...
              <div class="d-flex justify-content-center mt-3">
                <a href="editteacher.php?id=<?php echo $row['id'] ?>&s_id=<?php echo $id ?>" class="call_to-btn  ">
                  <span>
                    Edit
                  </span>
                  <img src="images/right-arrow.png" alt="">
      ...
      <div class="d-flex justify-content-center mt-3">
        <a href="newteacher.php?id=<?php echo $id ?>" class="call_to-btn  ">
